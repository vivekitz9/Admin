...
// import axios from "axios";
// import { useSelector } from "react-redux";
// import testUserData from "./testData.json";
...
//   const handleUpdateReadUnread = (user) => {};

//   // Open chat with a selected user
//   const handleSelectUser = (user) => {
//     handleUpdateReadUnread(user);
//     setSelectedUser(user);
//     setMessages([]);
//   };
//   // Send message
...
//         </Typography>
//         <List>
//           {/* {testUserData[0]?.length !== 0 &&
//             testUserData[0]?.map((item) => (
//               <ListItem
//                 key={item?.userId}
//                 button
//                 // onClick={() => handleSelectUser(item)}
...
//               </ListItem>
//             ))} */}
//           {testUserData.data.map((item) => (
//             <ListItem key={item.userId} button>
//               <Avatar sx={{ marginRight: 2 }}>{item.userName.charAt(0)}</Avatar>
//               <ListItemText
//                 primary={item.userName}
//                 secondary={
//                   item.unreadCount > 0
//                     ? `Unread Messages: ${item.unreadCount}`
//                     : "No unread messages"
//                 }
//               />
//             </ListItem>
